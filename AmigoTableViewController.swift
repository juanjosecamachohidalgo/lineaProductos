...
//  secondApp
//
//  Created by Inmaculada Mª Martínez Muñoz on 23/11/18.
...
class AmigoTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let amigo1 = Amigo(nombre: "Angelina", foto: UIImage(named:"Angelina")!, gAfinidad: 5)
        let amigo2 = Amigo(nombre: "Esmeralda", foto: UIImage(named:"Esmeralda")!, gAfinidad: 5)
        let amigo3 = Amigo(nombre: "David", foto: UIImage(named:"David")!, gAfinidad: 5)
